  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'add_hot_patching_metadata_transform.cc',
        'add_hot_patching_metadata_transform.h',
        ...
        'pe_hot_patching_basic_block_transform.cc',
        'pe_hot_patching_basic_block_transform.h',
    ...
    },
    {
      ...
      'sources': [
        ...
        'add_hot_patching_metadata_transform_unittest.cc',
